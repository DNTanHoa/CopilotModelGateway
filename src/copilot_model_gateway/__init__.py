...
from .quota_dashboard import install_quota_dashboard_extension
...
# Add built-in provider migration plus the basic provider quota/status endpoint
# before the CLI imports run_dashboard from the dashboard module.
install_dashboard_extensions()

# Add cached quota summaries, low-balance classification and forced refresh.
install_quota_dashboard_extension()
